...
class PowerProjectSidebar {
  ...
  setupEventListeners() {
    ...
    document
      .getElementById("import-groups-btn")
      .addEventListener("click", () => {
  ...
  async exportSavedGroups() {
    try {
      ...
      a.href = url;
      a.download = `power-project-groups-${
  ...
  async importSavedGroups(file) {
    try {
      ...
      alert("Error importing groups. Please check the file format.");
    }
  }
